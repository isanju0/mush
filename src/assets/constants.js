...
export const testimonials = [
  {
    ...
    role: "Home Chef",
    quote:
      "The mushrooms are always fresh, clean, and flavorful. I order every week and the quality has been consistent.",
  },
  {
    name: "Chef Arun D",
    role: "Restaurant Owner",
    quote:
      "Reliable supply and excellent texture in every batch. These mushrooms have become a staple in our kitchen.",
  },
  {
    name: "Neha Kapoor",
    role: "Nutrition Enthusiast",
    quote:
      "I love that the produce tastes natural and arrives well-packed. It genuinely feels premium and trustworthy.",
  },
];
